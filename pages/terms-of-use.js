...
const TermsOfUse = () => {
  return (
    <div className="terms-of-use">
      ...
      <h3>Privacy</h3>
      <p>
        We have developed a Privacy Policy in order to inform you of our practices with respect to the collection, use,
        disclosure and protection of personal information. You can find the Privacy Policy, which is incorporated into
        these Terms of Use, on our home page and by using this Site you agree to the terms of the Privacy Policy.
      </p>
      ...
      <h3>Notices</h3>
      <p>
        Unless otherwise specified in these Terms of Use, all notices under these Terms of Use will be in writing and
        will be deemed to have been duly given when received, if personally delivered or sent by certified or registered
        mail, return receipt requested; when receipt is electronically confirmed, if transmitted by facsimile or email;
        or the day after it is sent, if sent for next day delivery by recognized overnight delivery service.
      </p>
      <br />
      <p>
        Please feel free to contact us via one of the methods described on our Contact Us page. You agree that we may
        send notices to you regarding your use of the Site by means of electronic mail, a general notice posted on the
        Site or by written communication delivered either by overnight courier or U.S. mail to your email or mailing
        address as appearing in our records from time to time.
      </p>
      <br />
      <p>These Terms of Use were last updated January 2021.</p>
    </div>
  );
};
