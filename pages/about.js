        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-full sm:w-[500px] flex justify-center items-center flex-col lg:gap-9 gap-4">
            ...
            <p className="leading-6 text-center text-white">
              At the heart of our company is a diverse and dynamic group of individuals, each contributing their unique
              skills and perspectives to the world of marketing.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative w-full min-h-screen">
        ...
        <div className={`absolute inset-0 flex justify-center items-center`}>
          <div className="w-full sm:w-[550px] flex justify-center items-center flex-col lg:gap-9 gap-4">
            ...
            <p className="leading-6 text-center text-white">
              <br /> - Excellence is our commitment in every project we undertake.
              <br /> -We stay ahead with innovative solutions for our clients.
              <br /> -Transparent communication is our pledge throughout our partnerships.
            </p>
          </div>
        </div>
      </div>
